...
#endif
//global
//unsigned int NUM_ELEMENTS = 1024;	//1000-8000000
#ifndef NUM_ELEMENTS
#define	NUM_ELEMENTS	2000896		
#endif
//local
#ifndef LOCAL_SIZE
#define	LOCAL_SIZE		32	//Array Mult & Mult-Sum: 8-512, Array Mult Reduction: 32-256
#endif
...
int main( int argc, char *argv[ ] ) {
	...
	// did it work?
	// Who knows, this is a reduction so it isn't all that easy to test. This chunk was in the notes though.
	float sum = 0.;
	for (int i = 0; i < NUM_WORK_GROUPS; i++) {
		sum += hC[i];
	}

	//fprintf( stderr, "Local: %4d\tGlobal: %10d\t%10.3lf GigaMultsPerSecond\n",
		//LOCAL_SIZE, NUM_WORK_GROUPS, (double)NUM_ELEMENTS/(time1-time0)/1000000000. );
	fprintf(stderr, "%10.3lf\n", (double)NUM_ELEMENTS / (time1 - time0) / 1000000000.);
